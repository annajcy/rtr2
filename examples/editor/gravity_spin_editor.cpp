...
int main() {
    ...
    try {
        ...
        auto& rigid_body = bunny_go.add_component<rtr::framework::component::RigidBody>(runtime.physics_system().world());
        ...
        auto& physics_body = runtime.physics_system().world().get_rigid_body(rigid_body.rigid_body_id());
