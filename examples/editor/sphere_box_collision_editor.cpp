...
int main() {
    ...
    try {
        ...
        camera.camera_look_at_point_world(pbpt::math::Vec3{0.0f, 0.5f, 0.0f});

        auto& light_go = scene.create_game_object("main_light");
        light_go.node().set_local_position({2.0f, 6.0f, 4.0f});
        ...
        (void)sphere_go.add_component<rtr::framework::component::MeshRenderer>(
            bunny_mesh, pbpt::math::Vec4{0.88f, 0.82f, 0.75f, 1.0f});
        sphere_go.node().set_local_position({0.0f, 1.5f, 0.0f});
        sphere_go.node().set_local_scale({8.0f, 8.0f, 8.0f});

        auto& sphere_body = sphere_go.add_component<rtr::framework::component::RigidBody>(runtime.physics_system().world());
        (void)sphere_body;
        (void)sphere_go.add_component<rtr::framework::component::SphereCollider>(runtime.physics_system().world(), 0.1f);
        ...
        (void)floor_go.add_component<rtr::framework::component::MeshRenderer>(
            floor_mesh, pbpt::math::Vec4{0.24f, 0.28f, 0.31f, 1.0f});
