...
int main() {
    ...
    try {
        ...
        auto add_panel = [&](const std::string& name,
            ...
            (void)go.add_component<rtr::framework::component::BoxCollider>(half_extents);
            return rigid_body;
        };
        ...
        auto& ramp_ball = ramp_ball_go.add_component<rtr::framework::component::RigidBody>();
        ...
        (void)ramp_ball_go.add_component<rtr::framework::component::SphereCollider>(1.0f);
        ...
        auto& bounce_ball = bounce_ball_go.add_component<rtr::framework::component::RigidBody>();
        ...
        (void)bounce_ball_go.add_component<rtr::framework::component::SphereCollider>(1.0f);
        ...
        auto& target_ball = target_ball_go.add_component<rtr::framework::component::RigidBody>();
        ...
        (void)target_ball_go.add_component<rtr::framework::component::SphereCollider>(1.0f);
        ...
        auto& striker = striker_go.add_component<rtr::framework::component::RigidBody>();
        ...
        (void)striker_go.add_component<rtr::framework::component::BoxCollider>(pbpt::math::Vec3{0.5f, 0.5f, 0.10f});
        ...
        auto& spinner = spinner_go.add_component<rtr::framework::component::RigidBody>();
        ...
        (void)spinner_go.add_component<rtr::framework::component::BoxCollider>(pbpt::math::Vec3{0.5f, 0.5f, 0.08f});
