...
如果你要使用本地 HTTP MCP 工作流，请查看 [Headless MCP](headless-mcp.md)。

查看 [相机与坐标系约定](documentation/system/render/camera-coordinate-conventions.md) 了解 PBPT 与 RTR2 共享的矩阵链和 camera-space 规则。
