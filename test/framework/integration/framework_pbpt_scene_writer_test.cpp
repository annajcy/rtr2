...
TEST(FrameworkPbptSceneWriterTest, BuildsXmlResultFromActiveNodesWithMeshAndPbptMesh) {
    ...
    auto&                    renderer        = go_ok.add_component<component::StaticMeshComponent>(resources, expected_handle);
    ...
    (void)go_without_pbpt.add_component<component::StaticMeshComponent>(resources, create_test_mesh(resources));

    auto& go_with_disabled_component = scene.create_game_object("disabled_component");
    (void)go_with_disabled_component.add_component<component::StaticMeshComponent>(resources, create_test_mesh(resources));
    ...
    (void)go_disabled.add_component<component::StaticMeshComponent>(resources, create_test_mesh(resources));
...
TEST(FrameworkPbptSceneWriterTest, BuildXmlResultUsesPbptLightSpectrumAndKeepsPassthroughShapes) {
    ...
    (void)mapped_go.add_component<component::StaticMeshComponent>(resources, create_test_mesh(resources));
...
TEST(FrameworkPbptSceneWriterTest, BuildXmlResultSuffixesMappedMaterialWhenNameCollidesWithPassthrough) {
    ...
    const auto expected_handle = create_test_mesh(resources);
    auto&      renderer        = mapped_go.add_component<component::StaticMeshComponent>(resources, expected_handle);
